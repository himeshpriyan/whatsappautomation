...
export default function DemoModal({ isOpen, onClose, defaultPlan }: DemoModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
      ...
      {/* Modal Dialog */}
      <div className="relative w-full max-w-lg bg-white border border-slate-200 rounded-3xl shadow-2xl p-6 sm:p-8 z-10 text-slate-900 overflow-hidden">
        {/* Decorative Top Glow */}
        ...
        <button
          onClick={onClose}
          className="p-2 text-slate-400 hover:text-slate-700 rounded-xl hover:bg-slate-100 transition-colors absolute top-5 right-5 cursor-pointer"
        ...
        {isSuccess ? (
          <div className="text-center py-6">
            ...
            <h3 className="text-2xl font-bold text-slate-900 mb-2">You&apos;re All Set, {formData.name || "friend"}!</h3>
            <p className="text-slate-600 text-sm mb-6 max-w-sm mx-auto leading-relaxed">
              ...
              <strong className="text-emerald-700">{formData.phone || "your WhatsApp"}</strong> and email invitation.
            </p>
            <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200 text-left text-xs text-slate-700 space-y-2 mb-6">
              <div className="flex justify-between">
                <span className="text-slate-500">Selected Plan:</span>
                <span className="font-semibold text-emerald-700 uppercase">{defaultPlan || "Pro Trial"}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-500">Primary Goal:</span>
                <span className="font-semibold text-slate-900">{formData.useCase}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-500">Meta API Setup:</span>
                <span className="font-semibold text-cyan-700">Assisted Onboarding</span>
              </div>
            </div>
          ...
          <div>
            <div className="mb-6">
              ...
              <h3 className="text-2xl font-bold text-slate-900">Experience Zechsoft in Action</h3>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-300 rounded-xl pl-10 pr-4 py-2.5 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-[#25D366] focus:ring-2 focus:ring-[#25D366]/20"
                  />
                </div>
              </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-slate-50 border border-slate-300 rounded-xl pl-10 pr-3 py-2.5 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-[#25D366] focus:ring-2 focus:ring-[#25D366]/20"
                    />
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-slate-50 border border-slate-300 rounded-xl px-3 py-2.5 text-sm text-slate-900 focus:outline-none focus:border-[#25D366] focus:ring-2 focus:ring-[#25D366]/20"
                  >
