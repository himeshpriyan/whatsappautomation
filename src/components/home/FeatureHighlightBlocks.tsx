              ...
              >
                ...
                >
                  ...
                  <div className="space-y-3.5 pt-2">
                    {feature.subFeatures.map((sub, i) => (
                      <div
                        key={i}
                        className="flex items-start gap-3.5 p-3.5 rounded-2xl bg-slate-50 border border-slate-200/80 hover:border-emerald-300 transition-colors shadow-xs"
                      >
                ...
                >
                  <div className="relative group">
                    <div className="relative rounded-3xl bg-[#0F172A] border border-slate-800 p-6 sm:p-7 shadow-xl overflow-hidden text-white">
                      {/* Top Header Card */}
                      ...
                      {feature.imageType === "broadcast" && (
                        <div className="space-y-4">
                          <div className="p-4 rounded-2xl bg-gradient-to-br from-[#0B1120] to-[#1E293B] border border-emerald-500/30">
                          ...
                          <div className="p-3.5 bg-[#0B141A] rounded-2xl border border-white/10 space-y-2 text-xs">
                      ...
                      {feature.imageType === "chatbot" && (
                        <div className="space-y-4">
                          <div className="p-4 rounded-2xl bg-gradient-to-br from-[#0B1120] to-[#1E293B] border border-cyan-500/30">
                            <div className="flex items-center justify-between mb-3">
                              <span className="text-xs font-bold text-white flex items-center gap-2">
                            ...
                            <div className="flex flex-col gap-2 relative">
                              <div className="p-2.5 bg-slate-900 rounded-xl border border-emerald-500/40 text-xs flex items-center justify-between">
                              ...
                              <div className="p-2.5 bg-slate-900 rounded-xl border border-cyan-500/40 text-xs flex items-center justify-between">
                              ...
                              <div className="p-2.5 bg-slate-900 rounded-xl border border-purple-500/40 text-xs flex items-center justify-between">
