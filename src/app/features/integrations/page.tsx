    ...
    <div className="pt-8 pb-24 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-24">
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 pt-2">
              <div className="p-4 rounded-3xl bg-white border border-slate-200 shadow-sm">
                <div className="text-2xl sm:text-3xl font-black text-emerald-700">Ecosystem</div>
                <div className="text-xs text-slate-500 mt-1">Popular App Connectors</div>
              </div>
              <div className="p-4 rounded-3xl bg-white border border-slate-200 shadow-sm">
                <div className="text-2xl sm:text-3xl font-black text-emerald-600">&lt; 100ms</div>
                <div className="text-xs text-slate-500 mt-1">Webhook Latency</div>
              </div>
              <div className="p-4 rounded-3xl bg-white border border-slate-200 col-span-2 sm:col-span-1 shadow-sm">
                <div className="text-2xl sm:text-3xl font-black text-cyan-700">REST API</div>
                <div className="text-xs text-slate-500 mt-1">Developer-First Docs</div>
              </div>
            </div>
          ...
          <div className="lg:col-span-5 bg-slate-900 border border-slate-800 rounded-3xl p-6 shadow-xl space-y-4 text-white">
            ...
            <div className="bg-[#090D16] p-4 rounded-2xl font-mono text-[11px] text-slate-300 border border-white/5 overflow-x-auto space-y-1">
            ...
            <div className="p-3 bg-slate-950 rounded-xl border border-white/5 text-[11px] text-slate-400 flex items-center justify-between">
              ...
              >
                ...
                <div className="flex flex-wrap gap-2 pt-2">
                  {category.items.map((item) => (
                    <span
                      key={item}
                      className="px-3 py-1 bg-emerald-50 border border-emerald-200 rounded-lg text-xs font-semibold text-emerald-800"
                    >
                      {item}
                    </span>
                  ))}
