  ...
  return (
    <div className="pt-8 pb-24 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <Breadcrumb items={[{ label: "Features", href: "/features" }, { label: "Broadcast Marketing" }]} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-24">
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 pt-2">
              ...
              <div className="p-4 rounded-3xl bg-white border border-slate-200 shadow-sm">
                <div className="text-2xl sm:text-3xl font-black text-emerald-600">5.4x</div>
                <div className="text-xs text-slate-500 mt-1">ROI vs Standard Email</div>
              </div>
              <div className="p-4 rounded-3xl bg-white border border-slate-200 col-span-2 sm:col-span-1 shadow-sm">
                <div className="text-2xl sm:text-3xl font-black text-cyan-700">45-60%</div>
                <div className="text-xs text-slate-500 mt-1">Button Click-Through</div>
              </div>
            </div>
