          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 pt-2">
              <div className="p-4 rounded-3xl bg-white border border-slate-200 shadow-sm">
                ...
                <div className="text-xs text-slate-500 mt-1">Verified Mobile Numbers</div>
              </div>
              <div className="p-4 rounded-3xl bg-white border border-slate-200 shadow-sm">
                <div className="text-2xl sm:text-3xl font-black text-emerald-600">-45%</div>
                <div className="text-xs text-slate-500 mt-1">Lower Cost-Per-Lead</div>
              </div>
              <div className="p-4 rounded-3xl bg-white border border-slate-200 col-span-2 sm:col-span-1 shadow-sm">
                <div className="text-2xl sm:text-3xl font-black text-cyan-700">3.8x</div>
                <div className="text-xs text-slate-500 mt-1">Higher Conversion Rate</div>
              </div>
            </div>
          ...
          <div className="lg:col-span-5 bg-white border border-slate-200 rounded-3xl p-6 shadow-xl space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-slate-100">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-bold text-slate-900">Meta Ad ➔ WhatsApp Funnel</span>
              </div>
            ...
            <div className="space-y-3 text-xs">
              <div className="p-3.5 rounded-2xl bg-slate-50 border border-slate-200 space-y-2 shadow-2xs">
                <div className="flex items-center justify-between text-slate-500 text-[11px]">
                  ...
                  <span className="text-cyan-700 font-bold">0s Latency</span>
                </div>
                <p className="text-slate-900 font-medium">User clicks &ldquo;Send Message&rdquo; button on Instagram Feed.</p>
              </div>
              ...
              <div className="p-3.5 rounded-2xl bg-emerald-50 border border-emerald-200 space-y-2">
                <div className="flex items-center justify-between text-emerald-900 text-[11px]">
                  ...
                  <span className="text-emerald-700 font-bold">Auto-Trigger</span>
                </div>
                <p className="text-slate-700">Bot greets Alex, captures intent, and offers 15% first-time discount code.</p>
              </div>
              ...
              <div className="p-3.5 rounded-2xl bg-slate-50 border border-slate-200 space-y-2 shadow-2xs">
                ...
                <p className="text-slate-600">Purchase event logged into Meta Pixel & CAPI for algorithmic ad optimization.</p>
              </div>
            </div>
          </div>
        </div>
